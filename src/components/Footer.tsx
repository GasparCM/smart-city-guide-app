  ...
  return (
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-6 flex items-center">
              <span className="text-javea-blue">Javea</span><span className="text-javea-turquoise">2Live2</span>
            </h3>
            
            <p className="text-gray-400 mb-6">
              La plataforma SaaS que convierte tu municipio en un destino turístico inteligente.
            </p>
            
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-javea-blue flex-shrink-0 mt-0.5" />
                <span className="text-gray-400">Calle Thiviers 24, 03730 Jávea (Alicante)</span>
              </div>
              
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-javea-blue" />
                <span className="text-gray-400">+34 612 345 678</span>
              </div>
              
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-javea-blue" />
                <span className="text-gray-400">info@javea2live2.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#about" className="text-gray-400 hover:text-white transition-colors">¿Qué es Javea2Live2?</a>
              </li>
              <li>
                <a href="#features" className="text-gray-400 hover:text-white transition-colors">Funcionalidades</a>
              </li>
              <li>
                <a href="#how-it-works" className="text-gray-400 hover:text-white transition-colors">Para ayuntamientos</a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-gray-800 text-center lg:flex lg:justify-between lg:items-center">
          <p className="text-gray-500 mb-4 lg:mb-0">
            &copy; {new Date().getFullYear()} Javea2Live2. Todos los derechos reservados.
          </p>
          
          <div className="flex justify-center space-x-6">
            <a href="#" className="text-gray-500 hover:text-javea-blue transition-colors">
